...
namespace MachinesScripts
{
    public class RSA
    {
        ...
        public BigInteger
            FuncEllerFromModulN; // функция Эйлера от ModulN: funcEllerFromModulN = (simpleNumberOne - 1) * (simpleNumberTwo - 1)
        ...
        public string Decrypt(BigInteger[] ciphertext)
        {
            ...
            for (var i = 0; i < ciphertext.Length; i++)
            {
                ...
                BigInteger
                    m = BigInteger.ModPow(c, CloseExpo, ModulN); // расшифрование байта: m = c^CloseExpo mod ModulN
